...
if (!empty($bannerid))
{
    ...
    $translated_message = $translation->translate($message, array (
        MAX::constructURL(MAX_URL_ADMIN, "banner-approval.php?clientid=$clientid&campaignid=$campaignid&bannerid=$bannerid"), 
...
if(basename($_SERVER['HTTP_REFERER'] ) =='banner-approval.php') {
$return_url = 'banner-approval.php';
header("Location: ".$return_url."?clientid=".$clientid."&campaignid=".$campaignid);
}
 if(basename($_SERVER['HTTP_REFERER'] ) =='banners-approved.php') {
$return_url = 'banners-approved.php';
header("Location: ".$return_url."?clientid=".$clientid."&campaignid=".$campaignid);
}


//header("Location: banner-approval.php?clientid=".$clientid."&campaignid=".$campaignid);
