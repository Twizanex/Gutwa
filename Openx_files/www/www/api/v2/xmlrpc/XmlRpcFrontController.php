...
require_once 'InventoryXmlRpcService.php';
require_once 'SpecificationXmlRpcService.php';
require_once 'PaypalXmlRpcService.php';
/**
...
class XmlRpcFrontController
{
	...
	public function getInventoryList($message)
    {
        $service = new InventoryXmlRpcService();
        return $service->getInventoryList($message);
    }
	
	//Banner Specification function
	public function getSpecificationList($message)
    {
        $service = new SpecificationXmlRpcService();
        return $service->getSpecificationList($message);
    }

	public function getAdminPaypal($message)
    {
        $service = new PaypalXmlRpcService();
        return $service->getAdminPaypal($message);
    }
