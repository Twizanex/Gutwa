...
require_once MAX_PATH . '/www/api/v2/common/BasePaypalService.php';
 ...
 *
 */
class PaypalXmlRpcService extends BasePaypalService
{
    /**
     ...
     *
     */
    function PaypalXmlRpcService()
    {
        $this->BasePaypalService();
    }
     ...
     * @return generated result (data or error) */
	 ...
	 function getAdminPaypal(&$oParams) {
        ...
        $aInventoryList = null;
        if ($this->_oInventoryServiceImp->getAdminPaypal($sessionId, $aInventoryList)) {
