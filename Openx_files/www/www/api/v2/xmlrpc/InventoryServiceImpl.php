 ...
 *
 */
class InventoryServiceImpl extends BaseServiceImpl
{
    /**
     *
 ...
 function InventoryServiceImpl()
    {
        $this->BaseServiceImpl();
        $this->_dllInventory = new OA_Dll_Inventory();
    }
 ...
 function _validateResult($result)
  ...
  function getInventoryList($sessionId, &$aAgencyList)
    {
        if ($this->verifySession($sessionId)) {

            return $this->_validateResult(
                $this->_dllInventory->getInventoryList($aAgencyList));
        } else {
