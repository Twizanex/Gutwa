...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      echo "<html>\n";
      echo "<head><title>Processing Payment...</title><style type='text/css'>
	.pay{
...
text-align:center;
      ...
      echo "<div class='clean-gray'>Please wait, your order is being processed and you";
      echo " will be redirected to the paypal website.<br/><br/>If you are not automatically redirected to 
       paypal within 5 seconds...<br/><br/></div>\n";
      ...
      echo "<input type=\"submit\" value=\"Click Here\" class=\"pay\" >\n";
