...
/*OPenx mods*/
$oMenu->addTo("inventory", new OA_Admin_Menu_Section("inventory_products", 'Inventory Products', "oxm_inventory_products.php", false, "")); 

$oMenu->addTo("inventory", new OA_Admin_Menu_Section("banner-approval", 'Banner Approval', "banner-approval.php", false, "")); 

$oMenu->addTo("inventory", new OA_Admin_Menu_Section("banner-properties", 'Banner Specification', "banner-specification-index.php", false, "")); 

//$oMenu->addTo("banner-properties", new OA_Admin_Menu_Section("banner-spec", 'Add Banner Specification', "banner-specification-index.php", false, "")); 

$oMenu->addTo("banner-properties", new OA_Admin_Menu_Section("banner-spec_new", 'Add Banner Specification', "banner-specification-index.php", false, "")); 
/*OPenx mods*/
...
$oMenu->addTo("account-index", new OA_Admin_Menu_Section("account-user-index", 'UserPreferences', "account-user-index.php", false, ""));
 ...
 ///////////////////////// begin OpenX mods ////////////////////////////
			$oMenu->add(new OA_Admin_Menu_Section("add_inventory", 'Add Inventory', "oxm_add_inventory.php", false, "add_inventory"));
		    	$oMenu->addTo("add_inventory", new OA_Admin_Menu_Section("oxm_add_inventory", 'Add Inventory', "oxm_add_inventory.php", false, "")); 
