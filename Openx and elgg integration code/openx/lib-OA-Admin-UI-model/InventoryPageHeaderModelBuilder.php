...
class OA_Admin_UI_Model_InventoryPageHeaderModelBuilder
{
	...
	//print_r($entityClass);
        switch ($entityClass)
        {
			...
			case 'Banner-Approval':
               return array('label' => 'Banner-Approval', 'newLabel' => $GLOBALS['strAddBanner'], 
                'newTarget' => $GLOBALS['strBannerToCampaign'], 'class' => 'ban',
                'headerClass' => 'iconBannerLarge', 'newHeaderClass' => 'iconBannerAddLarge');	
	...
	case 'banner-properties':
               return array('label' => 'Banner Specification', 'headerClass' => 'iconAdvertisersLarge');	
