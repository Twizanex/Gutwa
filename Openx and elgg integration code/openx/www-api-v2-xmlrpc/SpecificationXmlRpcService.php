...
require_once MAX_PATH . '/www/api/v2/common/BaseSpecificationService.php';

// Require the XML-RPC utilities.
require_once MAX_PATH . '/www/api/v2/common/XmlRpcUtils.php';

// Require the ZoneInfo helper class.
require_once MAX_PATH . '/lib/OA/Dll/Specification.php';

/**
 * The ZoneXmlRpcService class the BaseZoneService class.
 *
 */
class SpecificationXmlRpcService extends BaseSpecificationService
{
    /**
     ...
     *
     */
    function SpecificationXmlRpcService()
    {
        $this->BaseSpecificationService();
    }
     ...
     * @return generated result (data or error) */
	 ...
	 function getSpecificationList(&$oParams) {
        ...
        $aInventoryList = null;
        if ($this->_oSpecificationServiceImp->getSpecificationList($sessionId, $aInventoryList)) {

            return XmlRpcUtils::getArrayOfEntityResponse($aInventoryList);
        } else {

            return XmlRpcUtils::generateError($this->_oSpecificationServiceImp->getLastError());
        }
    }
