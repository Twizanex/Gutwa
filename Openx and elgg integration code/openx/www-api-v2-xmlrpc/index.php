...
/**********************************************************************************
* TM:  Start Openx And Elgg Modification
***********************************************************************************/
   // Inventory Functions
			
 'ox.getInventoryList' => array(
        'function'  => array($fc, 'getInventoryList'),
        'signature' => array(
            array('array', 'string','int')
        ),
        'docstring' => 'Get Inventory List'
    ),

 'ox.getAdminPaypal' => array(
        'function'  => array($fc, 'getAdminPaypal'),
        'signature' => array(
            array('array', 'string')
        ),
        'docstring' => 'Get AdminPaypal List'
    ),
	
	//Banner Spec function
	 'ox.getSpecificationList' => array(
        'function'  => array($fc, 'getSpecificationList'),
        'signature' => array(
            array('array', 'string')
        ),
        'docstring' => 'Get Banner Specification List'
    ),

/**********************************************************************************
* TM:  End Openx And Elgg Modification
********************************************************************************/
